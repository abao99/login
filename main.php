...
<table width="50%" border="1" align="center">
  <tr>
    <td valign="middle">會員名稱:<?php echo $row_Recordset1['Username']; ?></td>
    <td align="right" valign="middle">帳號狀態:
	<?php 
		if($_SESSION['MM_UserGroup']==0)
			...
			echo'已認證';
		?>
    <a href="<?php echo $logoutAction ?>">登出</a></td>
  </tr>
  <tr>
    <td colspan="2" valign="middle">電子郵件帳號為:<?php echo $row_Recordset1['Email']; ?>
